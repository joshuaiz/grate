...
function grate_remove_dashboard_widgets() {
...
function grate_login_url() {  return home_url(); }

// changing the alt text on the logo to show your site name
function grate_login_title() { return get_option( 'blogname' ); }

// calling it only on the login page
add_action( 'login_enqueue_scripts', 'grate_login_css', 10 );
add_filter( 'login_headerurl', 'grate_login_url' );
add_filter( 'login_headertitle', 'grate_login_title' );
...
add_filter( 'admin_footer_text', 'grate_custom_admin_footer' );

function grate_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="https://studio.bio" target="_blank">studio.bio</a></span>. Built using <a href="https://studio.bio/template" target="_blank">Grate</a>.', 'grate' );
}
