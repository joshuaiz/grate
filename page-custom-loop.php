            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'hentry' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
                ...
                <header class="article-header">
                    ...
                    <div class="byline-wrap">
                        ...
                        if ( get_the_author_meta( 'ID' ) ) { $byline = sprintf(__( 'by %s', 'grate' ), '<span class="author vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . get_the_author() . '</a></span>' );

                            echo '<span class="posted-on">' . grate_time_link() . '</span><span class="byline"> ' . $byline . '</span>';

                        } else { echo '<span class="posted-on">Posted on:' . grate_time_link() . '</span>'; }
